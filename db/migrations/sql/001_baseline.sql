-- =====================================================================
-- MIGRATION 001 - BASELINE.  DONG BANG 24/08/2026.
--
-- KHONG BAO GIO DUOC SUA FILE NAY.
-- Migration da chay tren mot database la bat bien: may nay ap ban cu, may
-- dong nghiep ap ban moi, hai schema khac nhau ma bang alembic_version o ca
-- hai deu noi "da ap 001". Do la loi im lang, dung loai du an nay dung ra de
-- chong. Doi schema = THEM mot migration moi.
--
-- Than file duoi day chep NGUYEN VAN tu db/01_schema.sql tai thoi diem dong
