# gateway-image-delivery Specification

## Purpose
Image LiteLLM của Gateway được CI đóng gói từ nhánh có bản vá Sentinel của fork, gắn nhãn bất biến
theo commit fork, đẩy lên GHCR công khai, và được compose kéo về mà không cần thư mục fork ngang hàng
hay khoá bí mật trên máy chạy. Tạo khi archive change `package-the-gateway-image-in-ci` (15/09/2026).
## Requirements
