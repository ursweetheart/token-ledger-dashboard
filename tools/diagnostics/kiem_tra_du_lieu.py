...
Usage
    python tools/diagnostics/kiem_tra_du_lieu.py
    python tools/diagnostics/kiem_tra_du_lieu.py --bo-qua-monitoring   # bo qua 335 MB, chay nhanh
    python tools/diagnostics/kiem_tra_du_lieu.py --bao-cao ""          # chi in ra man hinh
"""
