"""Chup bo so bat bien cua database, va so hai ban chup voi nhau.
    ...
    python tools/diagnostics/baseline_db.py --save var/baselines/baseline-2026-08-24.json
    python tools/diagnostics/baseline_db.py --db postgresql://.../token_ledger_v2 \
                               --compare var/baselines/baseline-2026-08-24.json
