 ...
 *     node tools/diagnostics/audit_filter_combinations.js
 *
 * CAN backend that dang chay (postgres + api o 127.0.0.1:8000), giong
 * tools/diagnostics/run_dashboard_in_node.js. Vi vay no nam o tools/ chu khong o tests/:
...
// tools/diagnostics/chay_dashboard_trong_node.js: noi code SAU `})();` thi khong thay bien nao.
const PROBE = `
