...
- [Báo cáo Gateway smoke Ralli](./RALLI-TEST-REPORT.md): fallback 20/20 stage và hồi quy SpendLogs 93/93 request trên môi trường mock.
  ...
  - Bổ sung OCR: [5/5 OCR request/SpendLogs + LB-down fail-closed/recovery](./ralli-ocr-d3b5c0f18909.json), [JUnit focused suite 109/109](./ralli-ocr-focused-tests-20260916.xml), [JUnit full suite 836 pass/2 thiếu snapshot](./ralli-full-tests-20260916.xml), [harness OCR LB/hai Proxy](./ralli_ocr_lb_test.py). Đây là mock upstream, không phải Google-real.
...
- [Artifact JSON của lần chạy LB hiện hành (retest)](./law-lb-815c700c6af2.json)
  - Gồm kết quả 93 request, 8 synthetic users, 93 SpendLogs, LB trace và tài nguyên sau retest 11/09.
- [Artifact JSON của lần chạy LB ban đầu (lịch sử)](./law-lb-9cc2d0ed8f4f.json)
