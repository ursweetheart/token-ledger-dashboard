...
- [OCR fault artifact](../artifacts/current/law-ocr-0bb0c8d15e0c.json)
- [OCR JUnit 86/86](../artifacts/current/law-ocr-focused-tests-20260916.xml)
- [OCR LB harness](../harnesses/law_ocr_lb_test.py)
- [Text fallback 20/20](../artifacts/current/law-fallback-e3cee80a23d0.json)
- [Text LB/SpendLogs 93/93](../artifacts/current/law-lb-815c700c6af2.json)
...
- [OCR fault artifact](../artifacts/current/ralli-ocr-d3b5c0f18909.json)
- [OCR JUnit 109/109](../artifacts/current/ralli-ocr-focused-tests-20260916.xml)
- [Full-suite JUnit 838 tests](../artifacts/current/ralli-full-tests-20260916.xml)
- [OCR LB harness](../harnesses/ralli_ocr_lb_test.py)
- [Text fallback 20/20](../artifacts/current/ralli-fallback-de282363e783.json)
- [Text LB/SpendLogs 93/93](../artifacts/current/ralli-lb-aedefd25d9c6.json)
- [Google-real helper 6/6](../artifacts/current/ralli-google-de652caba3.json)
- [Direct fallback diagnostic](../artifacts/current/ralli-real-fallback-6f2ce026.json)
...
- [Billing/agent integration log](../../../docs/archive/gateway/token-ledger-billing-export-test-log.md)
- [DMS Gateway log](../../../docs/archive/gateway/dua-dms-qua-gateway-31-08.md)
- [CRM Gateway log](../../../docs/archive/gateway/dua-crm-qua-gateway-10-09.md)
- [CRM fallback log](../../../docs/archive/gateway/fallback-crm-12-09.md)
- [CRM 429/outage log](../../../docs/archive/gateway/ep-429-va-mat-gateway-10-09.md)
