...
PYTHONPATH='C:/token-ledger-dashboard/tools/gateway-smoke/identity-audit-support;backend' \
...
C:/token-ledger-dashboard/tools/gateway-smoke/identity-audit-support/test_active_paths.py \
-q --tb=short -rA
```
...
- `tools/gateway-smoke/identity-audit.md`
- `tools/gateway-smoke/identity-audit-support/sitecustomize.py`
- `tools/gateway-smoke/identity-audit-support/test_active_paths.py`
